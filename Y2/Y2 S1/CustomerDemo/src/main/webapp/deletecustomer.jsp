...
<% //to catch valuse here we use java part 
      ...
      <form action = "delete" method = "post"> <%-- to see user's previous inputs --%> 
        ...
        <tr>
            <td>First Name</td>
            <td><input type="text" name="first" value="<%= first %>"readonly></td> 
        </tr>
        
        <tr>
            <td>Last Name</td>
            <td><input type="text" name="last" value="<%= last %>"readonly></td> 
        </tr>
        <tr>
            <td>Email</td>
        ...
        <tr>
            <td>Address2</td>
            <td><input type="text" name="address2" value="<%= address2 %>"readonly></td> 
        </tr>
        <tr>
            <td>City</td>
        ...
        <tr>
            <td>Postal</td>
            <td><input type="text" name="postal" value="<%= postal %>"readonly></td> 
        </tr>
        <tr>
            <td>Type</td>
        ...
        <tr>
            <td>Goals</td>
            <td><input type="text" name="goals" value="<%= goals %>"readonly></td> 
        </tr>
        <tr>
            <td>Event Name</td>
        ...
        <tr>
            <td>Budject</td>
            <td><input type="text" name="budject" value="<%= budject %>"readonly></td> 
        </tr>
        <tr>
            <td>WhoPay</td>
            <td><input type="text" name="who" value="<%= who %>"readonly></td> 
        </tr>
        <tr>
            <td>Text</td>
            <td><input type="text" name="text" value="<%= text %>"readonly></td> 
        </tr>                                      
        <tr>
            <td>Attendence</td>
            <td><input type="text" name="attendence" value="<%= attendence %>"readonly></td> 
        </tr>         
        <tr>
            <td>RunTime</td>
            <td><input type="text" name="run" value="<%= run %>"readonly></td> 
        </tr>         
        <tr>
            <td>Repeating</td>
            <td><input type="text" name="repeat" value="<%= repeat %>"readonly></td> 
        </tr>        
        <tr>
            <td>Month</td>
        ...
        <tr>
            <td>Day</td>
            <td><input type="text" name="day" value="<%= day %>"readonly></td> 
        </tr>        
        <tr>
            <td>Year</td>
