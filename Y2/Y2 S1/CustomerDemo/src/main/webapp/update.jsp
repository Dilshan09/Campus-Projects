...
<header>
 ...
        </header>
    ...
    <h1 class = "p2" align="center">Update an Event Type</h1>
    <div class = "border">
    <div class = "p2">
        <form class="custom-form" action="update2" method="post">
            <label for="eventID">Enter the Event ID: </label><br>
            <input type="eventID" id="eventID" name="eventID"><br><br>
            ...
            <input type="text" id="venue2" name="venue2"><br><br>
