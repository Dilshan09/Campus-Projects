...
<body>
	...
	<%
		...
		String card = request.getParameter("ncard");
		String date = request.getParameter("ndate");
		String cvc = request.getParameter("ncvc");
	%>
    ...
    <div class="payment">
        ...
        <h2> Enter the new card details to update</h2>
        ...
        <div class="form" >
            ...
            <div class="card">
                ...
                <input type="text" class="input" name="id" placeholder="Your ID is assigned as 1" required>
            </div>
            
            <div class="card">
                <label class="label"> Card Holder Name :</label>
                <input type="text" class="input" name="name" placeholder=" New Account Name"required>
            </div>

            <div class="card">
                <label class="label"> Card Number :</label>
                <input type="text" class="input" name="card" placeholder=" New Card Number" data-mask="0000 0000 0000 0000 " required>
            </div>
            ...
            <div class="card-grp">
             ...
             <div class="btn">
                <input type="submit" name="submit" value="Update Card Details">
             </div>
